...
namespace BetterCms.Core.Security
{
    public class DefaultTextEncryptor : ITextEncryptor
    {
        ...
        public string Encrypt(string text)
        {
            ...
            {
                throw new PlatformException("Encryption failed.", ex);
            }
        }
        ...
        public string Decrypt(string encryptedText)
        {
            ...
            {
                throw new PlatformException("Decryption failed.", ex);
            }
        }
        ...
        {            
            if (keyBytes == null)
            {
                ...
                {
                    throw new PlatformException("A ContentEncryptionKey should be provided when an content encryption is enabled (<security enableContentEncryption=\"true\" contentEncryptionKey=\"any key to encrypt data\">)");
                }
