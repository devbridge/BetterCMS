...
"            <a class=\"bcms-tree-controls-edit\" data-bind=\"click: editItem, css: " +
"{\'bcms-tree-controls-edit-draft\': draft()}\"></a>\r\n                    <!-- /ko -" +
"->\r\n                    <!-- ko if: model.visibleButtons.delete -->\r\n           " +
"         <a class=\"bcms-tree-controls-delete\" data-bind=\"click: deleteItem\"></a>" +
"\r\n                    <!-- /ko -->\r\n                    <!-- /ko -->\r\n          " +
"          <!-- ko if: type == types.region -->\r\n                    <a class=\"bc" +
"ms-tree-controls-add\" data-bind=\"click: addContent\"></a>\r\n                    <!" +
"-- /ko -->\r\n                </div>\r\n            </div>\r\n            <!-- ko if: " +
"items().length > 0 -->\r\n            <div data-bind=\"with: items()\">\r\n           " +
"     <div data-bind=\"template: { name: \'bcms-contents-tree-list-template\' }\"></d" +
"iv>\r\n                <!-- ko if: $parent != null && $parent.types && $parent.typ" +
"e == $parent.types.region && $data.length == 1 -->\r\n                <div style=\"" +
"padding: 0; margin: 0;\" class=\"bcms-contents-tree-sort-block\" data-bind=\"draggab" +
"leContent: true\">&nbsp;</div>\r\n                <!-- /ko -->\r\n            </div>\r" +
"\n            <!-- /ko -->\r\n            <!-- ko if: type == types.region && items" +
"().length == 0 -->\r\n            <div class=\"bcms-contents-tree-sort-block\" data-" +
"bind=\"draggableContent:true\">&nbsp;</div>\r\n            <!-- /ko -->\r\n        </d" +
"iv>\r\n    </div>\r\n    <!-- /ko -->\r\n    <!-- /ko -->\r\n</script>");
