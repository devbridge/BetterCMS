...
namespace BetterCms.Module.Root.Mvc
{
    ...
    public class MimeTypeRouteConstraint : IRouteConstraint
    {
        ...
        /// <param name="routeKey">The route key that is being checked.</param>
        ...
        {
            return EmbeddedResourcesController.MimeTypes.ContainsKey(values[routeKey].ToString().ToLowerInvariant());
        }
    }
}