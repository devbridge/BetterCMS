...
namespace BetterCms.Module.Pages.Views.Page
{
    ...
    public partial class SearchUntranslatedPages : System.Web.Mvc.WebViewPage<BetterCms.Module.Pages.ViewModels.Filter.UntranslatedPagesGridViewModel<SiteSettingPageViewModel>>
    {
        public SearchUntranslatedPages()
        {
        }
...
WriteLiteral(">\r\n");
            ...
            #line 8 "..\..\Views\Page\SearchUntranslatedPages.cshtml"
     ...
     using (Html.BeginForm<PageController>(controller => controller.SearchUntranslatedPages(null), FormMethod.Post, new { @id = "bcms-pages-form", @class = "bcms-ajax-form" }))
    {
            ...
            #line 10 "..\..\Views\Page\SearchUntranslatedPages.cshtml"
   ...
   Write(Html.HiddenFor(m => m.ExistingItems, new {@id = "bcms-pages-excluded-pages"}));
            ...
            #line 14 "..\..\Views\Page\SearchUntranslatedPages.cshtml"
