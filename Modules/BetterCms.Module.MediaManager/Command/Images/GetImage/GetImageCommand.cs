            ...
            return new ImageViewModel
                {
                    ...
                    Url = FileUrlResolver.EnsureFullPathUrl(image.PublicUrl + string.Format("?{0}", DateTime.Now.ToString(MediaManagerModuleDescriptor.HardLoadImageDateTimeFormat))),
                    ThumbnailUrl = FileUrlResolver.EnsureFullPathUrl(image.PublicThumbnailUrl += string.Format("?{0}", DateTime.Now.ToString(MediaManagerModuleDescriptor.HardLoadImageDateTimeFormat))),
