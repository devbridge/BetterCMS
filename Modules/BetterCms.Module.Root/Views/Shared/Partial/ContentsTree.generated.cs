...
"&& $parent.types && $parent.type == $parent.types.region && $data.length == 1 --" +
">\r\n                <div style=\"padding: 0; margin: 0;\" class=\"bcms-contents-tree" +
"-sort-block\" data-bind=\"draggableContent: true\">&nbsp;</div>\r\n                <!" +
"-- /ko -->\r\n            </div>\r\n            <!-- /ko -->\r\n            <!-- ko if" +
": type == types.region && items().length == 0 -->\r\n            <div class=\"bcms-" +
"contents-tree-sort-block\" data-bind=\"draggableContent:true\">&nbsp;</div>\r\n      " +
"      <!-- /ko -->\r\n        </div>\r\n    </div>\r\n    <!-- /ko -->\r\n    <!-- /ko -" +
"->\r\n</script>");
