...
namespace BetterCms.Module.Root.Mvc.Helpers
{
    ...
    public static class JavaScriptModulesHelper
    {
        ...
        /// </returns>
        public static HtmlString RenderCommaSeparatedNamePathPairs(this IEnumerable<JavaScriptModuleViewModel> modules, bool useMinifiedPaths = false)
        {
            return new HtmlString(string.Join(", ", modules.Select(f => string.Concat("'", f.Name, "' : '", GetPathForJsInclude(f, useMinifiedPaths), "'"))));
        }

        private static string GetPathForJsInclude(JavaScriptModuleViewModel jsInclude, bool useMinifiedPaths = false)
        {
