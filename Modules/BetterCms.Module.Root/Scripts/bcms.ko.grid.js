        ...
        */
        grid.ItemViewModel = (function () {
            ...
            grid.ItemViewModel = function (parent, item) {
                ...
                self.onItemSelect = function (focusIdentifier, data, event) {
                    setTimeout(function() {
                        focusIdentifier(true);
                    }, 50);
                ...
                self.onBodyClickBound = function (e) {
                    self.onBodyClick.call(self, e);
                }
                bcms.on(bcms.events.bodyClick, self.onBodyClickBound);
            };
            ...
            grid.ItemViewModel.prototype.onBodyClick = function (e) {
                if (!this.isSelected) {
                    return;
                }
                if ($(e.target).closest('#' + this.getRowId()).length === 0) {
