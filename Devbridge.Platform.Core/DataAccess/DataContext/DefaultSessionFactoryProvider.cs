...
using Devbridge.Platform.Core.DataAccess.DataContext.Conventions;
using Devbridge.Platform.Core.DataAccess.DataContext.EventListeners;
using Devbridge.Platform.Core.DataAccess.DataContext.Interceptors;
...
namespace Devbridge.Platform.Core.DataAccess.DataContext
{
    public class DefaultSessionFactoryProvider : ISessionFactoryProvider
    {
        ...
        public DefaultSessionFactoryProvider(IMappingResolver mappingResolver, IConfiguration configuration, IPrincipalProvider principalProvider)
        {
